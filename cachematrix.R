## The following function will calculate the inverse of a matrix and will save it.
...
## This function will create a special "matrix" object, which is really a list 
...
makeCacheMatrix <- function(x = matrix()) {
        ## This creates a matrix object x and some associated sub-functions/methods
        
        ## This will define the cache m
        m <- NULL
        set <- function(y) {
...
## The following function will calculate the inverse of the special "matrix" created
